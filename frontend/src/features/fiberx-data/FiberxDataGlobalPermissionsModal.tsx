...
interface FiberxDataGlobalPermissionsModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const FiberxDataGlobalPermissionsModal = ({ isOpen, onClose }: FiberxDataGlobalPermissionsModalProps) => {
  ...
  const togglePermission = useMutation({
    mutationFn: async ({ id, canManage }: { id: string; canManage: boolean }) => {
      await api.put(`/employees/${id}/fiberx-permission`, {
        can_manage_fiberx_data: canManage,
      });
    },
    onSuccess: () => {
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        checked={emp.can_manage_fiberx_data}
