    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm">
      <div className="bg-card w-full max-w-md rounded-2xl shadow-xl border border-border overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="flex items-center justify-between p-4 border-b border-border">
          <h2 className="text-lg font-semibold text-foreground">Request Company Item</h2>
        ...
        <form onSubmit={(e) => {
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-1.5">Item Category</label>
            <select
              required
              value={categoryId}
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-1.5">Description / Reason</label>
            <textarea
              required
              value={description}
              ...
              rows={4}
              placeholder="Please provide details about the item you need..."
            />
          </div>
