...
// NewModuleAccessRepository constructs the repository.
//
// It deliberately performs no schema work. An earlier version ran CREATE TABLE
// statements, a deduplicating DELETE and a seed insert from here on every boot,
// which changed the database outside the migration series and only logged its
// failures. That work now lives in migrations 028 and 049.
