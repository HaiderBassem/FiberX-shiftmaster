...
type BoardRepository interface {
	GetAll(ctx context.Context) ([]models.TaskBoard, error)
...
func (r *boardRepo) GetAll(ctx context.Context) ([]models.TaskBoard, error) {
	rows, err := r.db.Query(ctx,
		`SELECT id, name, description, recurrence_type, is_active, created_by, created_at, updated_at
		 FROM task_boards ORDER BY created_at DESC`)
	if err != nil {
	...
	for rows.Next() {
		...
		if err := rows.Scan(&b.ID, &b.Name, &b.Description, &b.RecurrenceType,
			&b.IsActive, &b.CreatedBy, &b.CreatedAt, &b.UpdatedAt); err != nil {
...
func (r *boardRepo) Create(ctx context.Context, b *models.TaskBoard) error {
	return r.db.QueryRow(ctx,
		`INSERT INTO task_boards (name, description, recurrence_type, is_active, created_by)
		 VALUES ($1, $2, $3, $4, $5) RETURNING id, created_at, updated_at`,
		b.Name, b.Description, b.RecurrenceType, b.IsActive, b.CreatedBy,
	).Scan(&b.ID, &b.CreatedAt, &b.UpdatedAt)
}

func (r *boardRepo) Update(ctx context.Context, b *models.TaskBoard) error {
	_, err := r.db.Exec(ctx,
		`UPDATE task_boards SET name=$1, description=$2, recurrence_type=$3, is_active=$4, updated_at=CURRENT_TIMESTAMP
		 WHERE id=$5`,
		b.Name, b.Description, b.RecurrenceType, b.IsActive, b.ID)
	return err
}
